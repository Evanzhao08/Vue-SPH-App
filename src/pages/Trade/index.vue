  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{useDefaultAddress.fullAddress}}</span>
        收货人：<span>{{useDefaultAddress.consignee}}</span>
        <span>{{useDefaultAddress.phoneNum}}</span>
      </div>
    </div>
...
import {mapState} from 'vuex';
  export default {
    ...
    methods: {
        ...
        //  this.$forceUpdate()
          //全部的isDefault为零
         this.addressInfo =  addressInfo.forEach((item) => (item.isDefault = 0));
         address.isDefault = 1;
        },
        //提交订单
        async submitOrder(){
          let {tradeNo,detailArrayList} = this.orderInfo;
          let {consignee,phoneNum,fullAddress} = this.useDefaultAddress;
          let data = {
            "consignee": consignee,
